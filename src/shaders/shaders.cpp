...
{
    glUniformMatrix2fv(glGetUniformLocation(programs.begin()->second, name.c_str()), 1, GL_FALSE, &mat[0][0]);
}

void Shaders::setMat3(const std::string &name, const glm::mat3 &mat) const
{
    glUniformMatrix3fv(glGetUniformLocation(programs.begin()->second, name.c_str()), 1, GL_FALSE, &mat[0][0]);
}

void Shaders::setMat4(const std::string &name, const glm::mat4 &mat) const
{
    glUniformMatrix4fv(glGetUniformLocation(programs.begin()->second, name.c_str()), 1, GL_FALSE, &mat[0][0]);
}

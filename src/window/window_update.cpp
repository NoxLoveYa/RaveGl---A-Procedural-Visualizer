...
void Window::update() {
    ...
    GLuint                   vertexShader =
        shaders->compileShaderFromFile("src/shaders/glsl/vertex_shader.glsl", GL_VERTEX_SHADER);
    GLuint fragmentShader =
        shaders->compileShaderFromFile("src/shaders/glsl/fragment_shader.glsl", GL_FRAGMENT_SHADER);
